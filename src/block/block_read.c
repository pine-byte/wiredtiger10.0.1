...
/*
 * __wt_bm_read --
 *     Map or read address cookie referenced block into a buffer. 对应bm->read方法
 */
int
__wt_bm_read(
...
/*
 * __wt_block_read_off -- 包含具体的文件操作，block中存有dsk的原信息
 *     Read an addr/size pair referenced block into a buffer. 按照offset+size读取到buf中
 */
int
